...
FLASHBLADE_MGMT_IP = os.environ.get("FLASHBLADE_MGMT_IP",    "<FLASHBLADE_MGMT_IP>")
...
NFS_NODE_INSTANCE  = os.environ.get("NFS_NODE_INSTANCE",      "<K8S_WORKER_1>:9100")
...
class MetricsCollector:
    ...
    def _collect_system(self) -> dict:
        N29_INSTANCE = NFS_NODE_INSTANCE           # <K8S_WORKER_1>:9100 (worker .44 / n29)
        N25_INSTANCE = os.environ.get("N25_NODE_INSTANCE", "<K8S_WORKER_2>:9100")  # worker .40 / n25
        try:
